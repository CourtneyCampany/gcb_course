...
* **Submission windows:**
    + Project topic selection: February 4^th^
    + Term project rough drafts: March 25^th^
    + Term project peer reviews: April 15^st^
    + Final term project: April 15^th^
...
* **Paragraphs (i.e. Introduction) should be composed of multiple citations around a central theme**
    ...
    + overuse of one citation is a form of plagiarism
...
## Topic Selection: due February 4^th^
<hr>
<br/>
